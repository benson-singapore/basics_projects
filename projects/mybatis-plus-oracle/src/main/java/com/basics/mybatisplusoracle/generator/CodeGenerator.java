package com.basics.mybatisplusoracle.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.basics.mybatisplusoracle");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mapper/" + "Mapper" + StringPool.DOT_XML;
            }
        });
